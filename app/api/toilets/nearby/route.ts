 ...
 * `docs/adr/0007-recommendation-ranking-formula.md`). No filters, no
 * opening-hours evaluation yet. See `docs/adr/0006-nearby-api-contract.md`.
 *
...
export async function POST(request: Request) {
  ...
  return NextResponse.json({ results: ranked.map(toNearbyResult) });
}
